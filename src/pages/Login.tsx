...
import { Lock, Mail, ChevronRight, Activity, ArrowLeft } from 'lucide-react';
          ...
          <div className="relative z-10 space-y-10">
            <div className="text-center space-y-6">
              <div className="w-20 h-20 rounded-full bg-white/10 flex items-center justify-center mx-auto border border-white/10 shadow-inner">
                <Lock className="w-10 h-10 text-[#f1e194]" />
              </div>
              <h2 className="text-3xl font-light tracking-tight uppercase">Protocol Authentication</h2>
              <p className="text-[10px] text-[#f1e194]/40 uppercase tracking-[0.3em]">Identity Verification Required</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-full py-5 pl-14 pr-10 text-[11px] font-mono-tech uppercase tracking-widest text-[#f1e194] outline-none focus:border-white/30 transition-all" 
                    required
                  />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[9px] uppercase tracking-widest opacity-40 font-mono-tech ml-4">Access Key</label>
                <div className="relative">
            ...
            <p className="text-center text-[9px] font-mono-tech uppercase tracking-widest text-[#f1e194]/40">
              New to the node? <Link to="/signup" className="text-[#f1e194] hover:underline">Setup Protocol</Link>
            </p>
          </div>
        </div>
      </div>
